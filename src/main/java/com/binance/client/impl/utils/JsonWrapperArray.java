...
public class JsonWrapperArray {
    ...
    public BigDecimal getBigDecimalAt(int index) {
        ...
        try {
            ...
            throw new BinanceApiException(null, null,e.getMessage());
        }
    ...
    public void forEach(Handler<JsonWrapper> objectHandler) {
        array.forEach((object) -> {
            if (!(object instanceof JSONObject)) {
                throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR,BinanceApiException.RUNTIME_ERROR, "[Json] Parse array error in forEach");
            }
