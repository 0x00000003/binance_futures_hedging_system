...
public class JsonWrapper {
    ...
    public static JsonWrapper parseFromString(String text) {
        try {
            ...
            throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, BinanceApiException.RUNTIME_ERROR,"[Json] Fail to parse json: " + text);
        } catch (Exception e) {
            throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, BinanceApiException.RUNTIME_ERROR,"[Json] " + e.getMessage());
        }
    }
    ...
    public JsonWrapperArray getJsonArray(String name) {
        ...
        try {
            ...
            throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, BinanceApiException.RUNTIME_ERROR,"[Json] Get array: " + name + " error");
        }
        if (array == null) {
            throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR,BinanceApiException.RUNTIME_ERROR,
