...
public class UrlParamsBuilder {
    ...
    class ParamsMap {
        ...
        void put(String name, String value) {
            ...
            if (name == null || "".equals(name)) {
                throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, BinanceApiException.RUNTIME_ERROR,  "[URL] Key can not be null");
            }
    ...
    private static String urlEncode(String s) {
        try {
            ...
            throw new BinanceApiException(BinanceApiException.RUNTIME_ERROR, BinanceApiException.RUNTIME_ERROR, "[URL] UTF-8 encoding not supported!");
        }
    }
}
